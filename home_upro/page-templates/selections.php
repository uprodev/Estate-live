    ...
    <section class="home-block selection-inner">
        <div class="content-width">
            ...
            <div class="btn-wrap btn-add">
                <a href="<?php the_permalink(1719) . '?client_name=' . get_field('buyer_name', $_GET['selection_id']) ?>"><img src="<?= get_stylesheet_directory_uri() ?>/img/icon-100.svg" alt=""><?php _e('додати підбір', 'Home') ?></a>
            </div>
            <div class="content">
